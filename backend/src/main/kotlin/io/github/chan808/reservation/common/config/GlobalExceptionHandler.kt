package io.github.chan808.reservation.common.config

import io.github.chan808.reservation.common.BusinessException
...
class GlobalExceptionHandler {
    ...
    fun handleAccessDenied(request: HttpServletRequest): ResponseEntity<ProblemDetail> {
        val detail = buildProblemDetail(ErrorCode.ACCESS_DENIED, ErrorCode.ACCESS_DENIED.message, request.requestURI)
        return ResponseEntity.status(ErrorCode.ACCESS_DENIED.httpStatus).body(detail)
    }
